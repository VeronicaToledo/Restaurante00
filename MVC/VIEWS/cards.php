  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-2" >
        ...
        data-target="#myModalcad">Novo Evento Hoje</button>
    ...
    <?php
      ...
      $hoje = date('y-m-d');
      $hj = date('d-m-y');
      $result_atividade = "SELECT * FROM atividade ORDER BY ordem ASC";
      //ORDER BY pega os itens do banco de dados na ordem em que foram gravados pela ultima vez
                ...
                <div>
                  <div class="card-body" >
                    <form method="POST" action="mvc/model/muda_status.php">
                      ...
                      <?php echo $row_atividade['id'];?>">
                      <input name="condicao" type="hidden" value="
                      <?php echo $row_atividade['condicao'];?>">
                      <div class="row">
                        <button type="submit"class="btn btn-
                        <?php echo $status;?>"style="width: 170px; height: 50px;"><?php echo $text;?>
                        </button>
                      </div>
                    </form>
                  </div>
