...
<h4 class="mb-10 text-center" ><button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#Modal_categorias"  ><b>Novo Pedido</b></button></h4>
		...
		<h4>  Relação de Produtos :</h4>
          ...
          <table class="table table-striped table-sm" aria-describedby="descripcionTabla">
            <caption id="descripcionTabla">Tabla que muestra una lista de productos</caption>
	          <thead>
	            <tr>
	              <th id="numero">#</th>
	              <th id="id">ID</th>
	              <th id="pedido">Pedido</th>   
	              <th id="observaciones">Observações</th>
	              <th id="cantidad">Quantidade</th>
	              <th id="vUnitario">Valor Unitário</th>
	              <th id="acao">Ação</th>
	            </tr>
	          </thead>
	          <tbody>
	            ...
	            <tr>
	              <th id="total" scope="row"><b>TOTAL:</b></th>
	              < style="font-size: 22px; color: red;">R$: <?php echo number_format($total, 2);?></
