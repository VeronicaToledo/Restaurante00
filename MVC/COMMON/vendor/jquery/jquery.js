...
(function (global, factory) {
  ...
  var version = "3.3.1",
    ...
    jQuery = function (selector, context) {
      ...
      // Need init if jQuery is called (just allow error to be thrown if not used)
  ...
  var Sizzle =
	...
	---------------------------------------------------------------------- */
      ...
      getText = Sizzle.getText = function (elem) {
        ...
        // Do not use comment or processing instruction nodes
  ...
  // uses all common event props including KeyEvent and MouseEvent specific props
  jQuery.each(
    {
      altKey: true,
      bubbles: true,
  ...
  function genFx(type, useWidth) {
    var which,
      i = 0,
      attrs = { height: type };

    // If we use width, step value is 1 to do all cssExpand values,
    // otherwise step value is 2 to skip over Left and Right
    useWidth = useWidth ? 1 : 0;
    for (; i < 4; i += 2 - useWidth) {
      which = cssExpand[i];
  ...
  // keepScripts (optional): If true, will use scripts passed in the html string
