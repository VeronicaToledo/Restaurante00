      ...
      6: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            // uses scottish gaelic two word and hyphenated months
            var matchWord =
            ...
            function createDuration(input, key) {
              ...
              if (isDuration(input)) {
                ...
                duration = {
                  ...
                  ms: toInt(absRound(match[MILLISECOND] * 1000)) * sign, // the millisecond decimal point is used in the match
                };
      ...
      36: [
        function (require, module, exports) {
          ...
          function getTooltipSize(tooltip, model) {
            ...
            // Body lines may use some extra width due to the color box
      ...
      59: [
        function (require, module, exports) {
          ...
          function generate(min, max, capacity, options) {
            ...
            // Make sure that the last tick use max
            if (last < max) {
              last.add(1, minor);
            }
          ...
          module.exports = function () {
            ...
            var TimeScale = Scale.extend({
              initialize: function () {
                if (!moment) {
                  throw new Error(
                    "Chart.js - Moment.js could not be found! You must use it before Chart.js to use the time scale. Download at https://momentjs.com"
                  );
                }
