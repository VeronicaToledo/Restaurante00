                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 style="color: red;">Recuperación de contraseña</h1>
                      <h1 class="h4 text-gray-900 mb-4">Pergunta Clave</h1>
                      <h6>Ingrese su nombre de usuario y luego responda la pregunta que registró cuando creó su perfil</h6>
                    </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-xl-6 col-lg-12 col-md-9">
          ...
          <div class="card o-hidden border-0 shadow-lg my-5">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    ...
                    <form method="POST" action="">
                      <div class="form-group">
                        <input  class="form-control form-control-user text-center" name="responder" id="responder"
                        aria-describedby="emailHelp" placeholder="Resposta">
            ...
            <div class="col-12 text-center" id="mensagem" style="visibility: visible"><?php if (isset($_SESSION['msg'
            ])) {echo $_SESSION['msg'];unset($_SESSION['msg']); }?></div>
...
if ($responder != null) {
  if($responder == $resposta){
    ...
    $i = $senha;
    $_SESSION['msg'] = "<div class='alert alert-success' role='alert'>Respuesta correcta ! Tu contraseña es:$senha </div>";
    header("Location: http://localhost/pdv/?view=Dashboard1");

  }else{
    $_SESSION['msg'] = "<div class='alert alert-danger' role='alert'>Respuesta equivocada ! <br> ¡No se puede recuperar la contraseña! Intentar otra vez</div>";
